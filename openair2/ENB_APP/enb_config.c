...
#define ENB_CONFIG_STRING_PCCH_NPDCCH_NUMREPETITIONPAGING_NB_IOT                 "pcch_npdcch_NumRepetitionPaging_NB"
...
#define ENB_CONFIG_STRING_PCCH_NB_NB_IOT                                       "pcch_nB_NB"
...
const Enb_properties_array_t *enb_config_init(char* lib_config_file_name_pP)
{
  ...
  libconfig_int     pcch_npdcch_NumRepetitionPaging_NB      =0;
...
//
  ...
  memset((char*) (enb_properties.properties), 0 , MAX_ENB * sizeof(Enb_properties_NB_IoT_t *));
  memset((char*)active_enb,     0 , MAX_ENB * sizeof(char*));
...
# endif
      ...
      for (j=0; j < num_enb_properties; j++) {
        if (strcmp(active_enb[j], enb_name) == 0) {
          enb_properties.properties[enb_properties_index] = calloc(1, sizeof(Enb_properties_NB_IoT_t));
          ...
          if (setting_component_carriers != NULL) {
            ...
            for (j = 0; j < num_component_carriers /*&& j < MAX_NUM_CCs*/; j++) {
              ...
              if (!(config_setting_lookup_string(component_carrier, ENB_CONFIG_STRING_CC_NODE_FUNCTION, &cc_node_function)
                   ...
                   && config_setting_lookup_int(component_carrier, ENB_CONFIG_STRING_BCCH_MODIFICATIONPERIODCOEFF_NB_IOT,  &bcch_modificationPeriodCoeff_NB)
                   && config_setting_lookup_int(component_carrier, ENB_CONFIG_STRING_PCCH_DEFAULT_PAGING_CYCLE_NB_IOT,  &pcch_defaultPagingCycle_NB)
                   && config_setting_lookup_int(component_carrier, ENB_CONFIG_STRING_PCCH_NPDCCH_NUMREPETITIONPAGING_NB_IOT,  &pcch_npdcch_NumRepetitionPaging_NB)
                   && config_setting_lookup_int(component_carrier, ENB_CONFIG_STRING_NPRACH_CP_LENGTH_NB_IOT,  &nprach_CP_Length)
                   && config_setting_lookup_int(component_carrier, ENB_CONFIG_STRING_NPRACH_RSRP_RANGE_NB_IOT,  &nprach_rsrp_range)
                   && config_setting_lookup_int(component_carrier, ENB_CONFIG_STRING_NPDSCH_NRS_POWER_NB_IOT,  &npdsch_nrs_Power)
                   && config_setting_lookup_int(component_carrier, ENB_CONFIG_STRING_NPUSCH_ACK_NACK_NUMREPETITIONS_NB_IOT,  &npusch_ack_nack_numRepetitions_NB)
                   ...
                   && config_setting_lookup_int(component_carrier, ENB_CONFIG_STRING_NPDCCH_STARTSF_CSS_RA_NB_IOT,  &npdcch_StartSF_CSS_RA)
                   && config_setting_lookup_string(component_carrier, ENB_CONFIG_STRING_NPDCCH_OFFSET_RA_NB_IOT,  &npdcch_Offset_RA)
                   && config_setting_lookup_string(component_carrier, ENB_CONFIG_STRING_PCCH_NB_NB_IOT,  &pcch_nB_NB)
    ...
    switch (rach_raResponseWindowSize_NB) {
      ...
      if (strcmp(dl_GapDurationCoeff_NB, "oneEighth") == 0) {
                enb_properties.properties[enb_properties_index]->dl_GapDurationCoeff_NB = DL_GapConfig_NB_r13__dl_GapDurationCoeff_r13_oneEighth;
              } else if (strcmp(dl_GapDurationCoeff_NB, "oneFourth") == 0) {
                enb_properties.properties[enb_properties_index]->dl_GapDurationCoeff_NB = DL_GapConfig_NB_r13__dl_GapDurationCoeff_r13_oneFourth;
              } else if (strcmp(dl_GapDurationCoeff_NB, "threeEighth") == 0) {
                enb_properties.properties[enb_properties_index]->dl_GapDurationCoeff_NB = DL_GapConfig_NB_r13__dl_GapDurationCoeff_r13_threeEighth;
              } else if (strcmp(dl_GapDurationCoeff_NB, "oneHalf") == 0) {
                enb_properties.properties[enb_properties_index]->dl_GapDurationCoeff_NB = DL_GapConfig_NB_r13__dl_GapDurationCoeff_r13_oneHalf;
              } else
                AssertFatal (0,
                             "Failed to parse eNB configuration file %s, enb %d unknown value \"%s\" for dl_GapDurationCoeff_NB choice: oneEighth,oneFourth,threeEighth,oneHalf !\n",
                             lib_config_file_name_pP, i, dl_GapDurationCoeff_NB);
     ...
     if (strcmp(npusch_alpha,"AL0")==0) {
      ...
      switch (nprach_StartTime) {
        ...
        if (strcmp(nprach_SubcarrierMSG3_RangeStart, "zero") == 0) {
                enb_properties.properties[enb_properties_index]->nprach_SubcarrierMSG3_RangeStart = NPRACH_Parameters_NB_r13__nprach_SubcarrierMSG3_RangeStart_r13_zero;
              } else if (strcmp(nprach_SubcarrierMSG3_RangeStart, "oneThird") == 0) {
                enb_properties.properties[enb_properties_index]->nprach_SubcarrierMSG3_RangeStart = NPRACH_Parameters_NB_r13__nprach_SubcarrierMSG3_RangeStart_r13_oneThird;
              } else if (strcmp(nprach_SubcarrierMSG3_RangeStart, "twoThird") == 0) {
                enb_properties.properties[enb_properties_index]->nprach_SubcarrierMSG3_RangeStart = NPRACH_Parameters_NB_r13__nprach_SubcarrierMSG3_RangeStart_r13_twoThird;
              } else if (strcmp(nprach_SubcarrierMSG3_RangeStart, "one") == 0) {
                enb_properties.properties[enb_properties_index]->nprach_SubcarrierMSG3_RangeStart = NPRACH_Parameters_NB_r13__nprach_SubcarrierMSG3_RangeStart_r13_one;
              } else
                AssertFatal (0,
                             "Failed to parse eNB configuration file %s, enb %d unknown value \"%s\" for nprach_SubcarrierMSG3_RangeStart choice: zero,oneThird,twoThird,one !\n",
                             lib_config_file_name_pP, i, nprach_SubcarrierMSG3_RangeStart);
      ...
      switch (npdcch_StartSF_CSS_RA) {
        ...
        if (strcmp(npdcch_Offset_RA, "zero") == 0) {
                enb_properties.properties[enb_properties_index]->npdcch_Offset_RA = NPRACH_Parameters_NB_r13__npdcch_Offset_RA_r13_zero;
              } else if (strcmp(npdcch_Offset_RA, "oneEighth") == 0) {
                enb_properties.properties[enb_properties_index]->npdcch_Offset_RA = NPRACH_Parameters_NB_r13__npdcch_Offset_RA_r13_oneEighth;
              } else if (strcmp(npdcch_Offset_RA, "oneFourth") == 0) {
                enb_properties.properties[enb_properties_index]->npdcch_Offset_RA = NPRACH_Parameters_NB_r13__npdcch_Offset_RA_r13_oneFourth;
              } else if (strcmp(npdcch_Offset_RA, "threeEighth") == 0) {
                enb_properties.properties[enb_properties_index]->npdcch_Offset_RA = NPRACH_Parameters_NB_r13__npdcch_Offset_RA_r13_threeEighth;
              } else
                AssertFatal (0,
                             "Failed to parse eNB configuration file %s, enb %d unknown value \"%s\" for npdcch_Offset_RA choice: zero,oneEighth,oneFourth,threeEighth !\n",
                             lib_config_file_name_pP, i, npdcch_Offset_RA);
        ...
        //****************************************************************************************************************
          ...
          if (setting_srb1 != NULL) {
            ...
            if (srb1_timer_status_prohibit <= 250) {
             ...
             if (strcmp(pcch_nB_NB, "fourT") == 0) {
                enb_properties.properties[enb_properties_index]->pcch_nB_NB[j] = PCCH_Config_NB_r13__nB_r13_fourT;
              } else if (strcmp(pcch_nB_NB, "twoT") == 0) {
                enb_properties.properties[enb_properties_index]->pcch_nB_NB[j] = PCCH_Config_NB_r13__nB_r13_twoT;
              } else if (strcmp(pcch_nB_NB, "oneT") == 0) {
                enb_properties.properties[enb_properties_index]->pcch_nB_NB[j] = PCCH_Config_NB_r13__nB_r13_oneT;
              } else if (strcmp(pcch_nB_NB, "halfT") == 0) {
                enb_properties.properties[enb_properties_index]->pcch_nB_NB[j] = PCCH_Config_NB_r13__nB_r13_halfT;
              } else if (strcmp(pcch_nB_NB, "quarterT") == 0) {
                enb_properties.properties[enb_properties_index]->pcch_nB_NB[j] = PCCH_Config_NB_r13__nB_r13_quarterT;
              } else if (strcmp(pcch_nB_NB, "oneEighthT") == 0) {
                enb_properties.properties[enb_properties_index]->pcch_nB_NB[j] = PCCH_Config_NB_r13__nB_r13_one8thT;
              } else if (strcmp(pcch_nB_NB, "oneSixteenthT") == 0) {
                enb_properties.properties[enb_properties_index]->pcch_nB_NB[j] = PCCH_Config_NB_r13__nB_r13_one16thT;
              } else if (strcmp(pcch_nB_NB, "oneThirtySecondT") == 0) {
                enb_properties.properties[enb_properties_index]->pcch_nB_NB[j] = PCCH_Config_NB_r13__nB_r13_one32ndT;
              } else
                AssertFatal (0,
                             "Failed to parse eNB configuration file %s, enb %d unknown value \"%d\" for pcch_nB_NB choice: fourT,twoT,oneT,halfT,quarterT,oneighthT,oneSixteenthT,oneThirtySecondT !\n",
                             lib_config_file_name_pP, i, pcch_defaultPagingCycle);

            switch (pcch_npdcch_NumRepetitionPaging_NB) {
              case 1:
                enb_properties.properties[enb_properties_index]->pcch_npdcch_NumRepetitionPaging_NB[j] = PCCH_Config_NB_r13__npdcch_NumRepetitionPaging_r13_r1;
                break;

              case 2:
                enb_properties.properties[enb_properties_index]->pcch_npdcch_NumRepetitionPaging_NB[j] = PCCH_Config_NB_r13__npdcch_NumRepetitionPaging_r13_r2;
                break;

              case 4:
                enb_properties.properties[enb_properties_index]->pcch_npdcch_NumRepetitionPaging_NB[j] = PCCH_Config_NB_r13__npdcch_NumRepetitionPaging_r13_r4;
                break;

               case 8:
                enb_properties.properties[enb_properties_index]->pcch_npdcch_NumRepetitionPaging_NB[j] = PCCH_Config_NB_r13__npdcch_NumRepetitionPaging_r13_r8;
                break;

               case 16:
                enb_properties.properties[enb_properties_index]->pcch_npdcch_NumRepetitionPaging_NB[j] = PCCH_Config_NB_r13__npdcch_NumRepetitionPaging_r13_r16;
                break;

               case 32:
                enb_properties.properties[enb_properties_index]->pcch_npdcch_NumRepetitionPaging_NB[j] = PCCH_Config_NB_r13__npdcch_NumRepetitionPaging_r13_r32;
                break;

              default:
                AssertFatal (0,
                             "Failed to parse eNB configuration file %s, enb %d unknown value \"%d\" for pcch_npdcch_NumRepetitionPaging_NB choice: 1,2,4,8,16,32 ",
                             lib_config_file_name_pP, i, pcch_npdcch_NumRepetitionPaging_NB);
                break;
